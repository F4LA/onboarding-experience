...
- **Whether the new intake form carries a life-stage question.** The age split no longer needs it for avatar matching. But menopause status is now a pacing input for the coach and the roadmap tiers, and the coach has no way to know it. One field. Affects the intake build — decide before Bernardo builds the form.
