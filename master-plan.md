...
- La duración de Foundational se pregunta con botones, y los tres números salen del rango de la fila de ese cliente — 6, 7 y 8 en la fila de cuatro hábitos contados, no un juego fijo. La propuesta dentro del rango la sigue gobernando la dificultad, sin cambios. Toda pantalla con botones cierra además nombrando las respuestas válidas en una oración, que es el respaldo cuando los botones no renderizan.
