...
> **Proposed content spec for M9 (NOT LOCKED — pending the structural meeting, Monday August 31, 2026).** Eleven-part flow proposed by Bernardo, reconciled against Brent's audit, from https://docs.google.com/document/d/1IGRjdIHNNFwrbXAc8FE4bQP5cic9vD2QIJs2GSeQBCs/edit ("The flow I'm proposing"):
>
> | # | Part | What happens |
> |---|------|--------------|
> | 1 | Cover | Open on it while we build rapport and start the conversation. Strong Standard branding. |
> | 2 | Agenda | What we're covering today and how long the call runs. Right now we go from the cover straight into goals with no transition, so the client has no idea what the session is. |
> | 3 | Your Goals | Straight from the intake form: what made them decide to start now, why it matters to them, and the numeric goal based on what they selected — goal weight, goal body fat, or both. If a goal doesn't fit the timeframe they asked for, the coach says so here, out loud, and says he's about to show what is achievable. That doesn't need a slide. |
> | 4 | Roadmap | The three phases, explained once. Sub-phases collapse under the phase they belong to and the client can open them. Foundational gets real depth — that's where they see how personalized this is. For Body Composition we give the date range, the duration, the total outcome, and we name the three sub-phases with their purpose. We do not walk through each sub-phase in detail; we say we'll go deep on each when they get there, and they can open the deck themselves if they want to look ahead. Lifestyle we explain but don't detail, because what it looks like for them is a conversation we have when we get there. |
> | 5 | Case study | Right after the roadmap. The roadmap raises the question of whether this actually works, and the case study answers it while the question is live. One case, the closest match to this client. |
> | 6 | What to expect | Organized by rhythm: day to day, week to week, monthly or longer. This absorbs three slides that are separate today — responsibilities, community calls, and mesocycle reviews. Responsibilities stop being their own category and get said inside the rhythm: habits when we talk about the day, videos when we talk about training, the check-in when we talk about the week. The check-in gets a real explanation here — what it is and why we need it on time. The third bucket is "monthly or longer" rather than "every 8 weeks", because calls that alternate get misread as happening every 8 weeks each. The mesocycle call gets booked at the end of this section. |
> | 7 | Minimum Standards | After the rhythm, not before — you can't set the bar for something the client doesn't know exists yet. Four: nutrition adherence, training adherence, technique feedback, movement. The framing that this is consistency and not perfection stays. |
> | 8 | Your First Week Goals | Training kept simple: days per week and what the program is aiming at, plus the line that this first week is our best educated guess from what we know today, and that every week, every month, and especially every 8 weeks we learn more and personalize it further. Nutrition goals and which habits we're working on. The tasks we're assigning. What's in here depends on their intake and roadmap — meal prep and the flexible meal plan aren't mandatory for everyone anymore. |
> | 9 | Closing question | Spoken, no slide. How are you feeling about the plan — and specifically, what do you think of the long-term roadmap we built for you. This is the hinge into the offer. |
> | 10 | Offer | Both slides as they are. One change: the slide states no deadline. It says special offer, and the actual deadline lives in the process. |
> | 11 | Payment options | Only if they say yes. Today we show it to everyone including people who already declined. |
>
> What comes out: the client responsibilities slide, the community calls slide and the mesocycle slide stop being their own slides. The satisfaction questionnaire leaves the call entirely. Four live disagreements with Brent (offer placement, naming sub-phases up front, whether Week 1 is delivered complete on the call, and confirming the roadmap opens the call) go to the Monday meeting — see Open decisions in the Project Brain. This spec is not locked until then.
